...
export const projectsData = [
  {
    name: 'EstimServ – Sistema de Orçamentos Inteligente (video com maiores detalhes abaixo) ',
    desc: '',
  ...
  {
    name: 'Site Dashboard completo para sites de Impressão 3D (video com maiores detalhes abaixo)',
    desc: '.',
